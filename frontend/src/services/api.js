...
// ✅ Auth
export const googleLogin = (credential) => api.post('/api/auth/google', { credential }); // was /auth/google
export const getCurrentUser = () => api.get('/api/auth/me');                              // was /auth/me
...
export const updateEmployee = (id, data) => api.put(`/api/manager/employees/${id}`, data);
export const deleteEmployee = (id) => api.delete(`/api/manager/employees/${id}`);
export const generateOtp = (data) => api.post('/api/manager/attendance/generate-otp', data);
export const generateQrCode = (data) => api.post('/api/manager/attendance/qr', data);
export const getEmployeeAttendance = (id) => api.get(`/api/manager/attendance/${id}`);
...
export const updateLeaveStatus = (id, status, comment = '') =>
  api.put(`/api/manager/leaves/${id}?status=${status}&comment=${encodeURIComponent(comment)}`);

// ✅ Employee APIs
export const getProfile = () => api.get('/api/employee/profile');
export const getMyAttendance = () => api.get('/api/employee/attendance');
export const markMyAttendance = (data) => api.post('/api/employee/attendance/mark', data);
export const applyLeave = (data) => api.post('/api/employee/leave', data);
